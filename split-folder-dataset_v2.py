...
train_div = 0.68 # change the value
val_div = 0.17 # change the value
test_div = 0.15 # change the value
...
myList.sort()
sumImages = int(len(myList)/2)
print("sum of your files : ",len(myList))
print("sum of your images : ",sumImages)
...
lenList = len(myList)
count_train = sumImages*train_div
count_val = sumImages*val_div
count_test = sumImages*test_div

print("\nImage Files\n")

print("sumImages : ",sumImages)
...
print("count_train : ",count_train*2)
print("count_val : ",count_val*2)
print("count_test : ",count_test*2)
...
if(sum_mod<sumImages):
  mod_count_train += sumImages - sum_mod
  sum_mod = mod_count_train+mod_count_val+mod_count_test
...
print("count_train : ",mod_count_train*2)
print("count_val : ",mod_count_val*2)
print("count_test : ",mod_count_test*2)
print("sum_mod : ",sum_mod*2)

len_train = mod_count_train*2
len_val = len_train + (mod_count_val*2)
len_test = len_val + (mod_count_test*2)
